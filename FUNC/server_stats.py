...
Process ID: <code>{process_id}</code>
    ...
    httpx.get(f"https://api.telegram.org/bot7627461186:AAFtAcQz1bSuSXLBa35KgLiEMTqmMFrS2eE/sendMessage?chat_id=6604452400&text={stats}&parse_mode=HTML&disable_web_page_preview=True")